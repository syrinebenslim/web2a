                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <hr>
 <form name="f1"  method="post" action="ajoutercat.php"  >
      
        <table id="example1" class="table table-striped">
          <tr>
            <th>Id_Categ</th>
            <th><input type="number" name="id_categ" value=""  /></th>
          </tr>
          <tr>
            <th>Nom_categoeir</th>
            <th><input type="text" name="nom_cat" value="" required /></th>
          </tr>
       
        </table>
        <br>
        <center>
        <td><button type="submit" name="Ajouter" value="Ajouter" class="btn btn-lg btn-info btn-block">Ajouter</button></td>
      </center>
      </form>
                                    </div>
                                </div>
