...
$prod=$utic->afficherutilisateur(1);
$tec=$utic->afficherutilisateur(0);
$four=$utic->afficherutilisateur(2);
    ...
    if(!empty($_SESSION['role']))
{
    ...
    {
?>
                        <a href="dec.php"> <i class="menu-icon fa fa-dashboard"></i> Déconnecter </a>
        ...
        <div class="content mt-3">
         ...
         <div>
            <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="Ajouterutilisateur.php">Ajouter Admin</a>
             
            </button>
              <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
               <a href="statuti.php">Statestique</a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                   ...
                                   <form  method="POST" action="rechuti.php">
                    <input class="form-control bg-dark border-0" type="search" placeholder="Search" name="rech">
                </form> 
                                                              <div class="card-header">
...
?>
                                            ...
                                            <td> <?php echo $pro['id_utilisateur'] ?> </td>
                                            <td><?php echo $pro['nom'] ?></td>
                                            <td><?php echo $pro['prenom'] ?></td>
                                            <td><?php echo $pro['adresse'] ?></td>
                                            <td><?php echo $pro['mdp'] ?></td>
                                             <td><?php echo $pro['role'] ?></td>
                                   ...
                                   <td>     <form method="post" action="supprumerutilisateur.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_utilisateur'] ?>" name="id_utilisateur">
</form></td>
<td> 
...
<input type="hidden" value="<?php echo $pro['id_utilisateur'] ?>" name="id_utilisateur">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Utilisateur</strong>
                            </div>
...
?>
                                            ...
                                            <td><?php echo $rec['prenom'] ?></td>
                                            <td><?php echo $rec['adresse'] ?></td>
                                            <td><?php echo $rec['mdp'] ?></td>
                                   ...
                                   <td>     <form method="post" action="supprumerutilisateur.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $rec['id_utilisateur'] ?>" name="id_utilisateur">
</form></td>
<td> 
<form method="GET" action="Modifierutilisateur.php" >
<input type="submit" value="Modifier"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $rec['id_utilisateur'] ?>" name="id_utilisateur">
                                   ...
                                   <div class="card-header">
                                <strong class="card-title">Fournissuer</strong>
                            </div>
                                   ...
                                   <table  class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
 <?php
foreach($four as $fourn){

?>

                                            <td> <?php echo $fourn['id_utilisateur'] ?> </td>
                                            <td><?php echo $fourn['nom'] ?></td>
                                            <td><?php echo $fourn['prenom'] ?></td>
                                            <td><?php echo $fourn['adresse'] ?></td>
                                            <td><?php echo $fourn['mdp'] ?></td>
                                             <td><?php echo $fourn['role'] ?></td>
                                   ...
                                   <td>     <form method="post" action="supprumerutilisateur.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $fourn['id_utilisateur'] ?>" name="id_utilisateur">
</form></td>
<td> 
<form method="GET" action="Modifierutilisateur.php" >
<input type="submit" value="Modifier"class="btn btn-primary btn-lg" >
