        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">DANGER</span> Cannot delete or update a parent row: a foreign key constraint fails 
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light"> Membres en ligne</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <h4 class="card-title mb-0">Visiteurs</h4>
                                ...
                                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group mr-3" data-toggle="buttons" aria-label="First group">
                                        <label class="btn btn-outline-secondary">
                                            <input type="radio" name="options" id="option1"> Jour
                                        </label>
                                        <label class="btn btn-outline-secondary active">
                                            <input type="radio" name="options" id="option2" checked=""> Mois
                                        </label>
                                        <label class="btn btn-outline-secondary">
                                            <input type="radio" name="options" id="option3"> Année
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        <ul>
                            ...
                            <li class="hidden-sm-down">
                                <div class="text-muted">Taux de rebond</div>
                                <strong>40.15%</strong>
                                <div class="progress progress-xs mt-2" style="height: 5px;">
                    ...
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-light">Gestionnaire de projet</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Bénéfice total</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Nouveau client</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text"> Projets actifs</div>
