                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">  <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
...
?>
     ...
     <div class="col-sm-12">
                <div class="alert alert-success" role="alert">
                    <span class="alert alert-success">success</span> Bonjour <?php echo  $_SESSION['LOGGED_USER'] ; ?>
...
{  ?>
     ...
     <div class="col-sm-12">
                <div class="alert alert-danger" role="alert">
                    <span class="alert alert-danger"></span> connecte
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
