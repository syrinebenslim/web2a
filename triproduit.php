            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <input class="form-control bg-dark border-0" type="search" placeholder="Search" name="rech">
                           ...
                           <strong class="card-title"><a href="triproduit.php">Trie par prix</a></strong><br>
                                  <strong class="card-title"><a href="table-produit.php">Retoure</a></strong><br>
...
<input type="hidden" value="<?php echo $pro['id_produit'] ?>" name="id_produit">
</form></td>
<td> 
