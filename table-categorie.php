                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                  ...
                                  <strong class="card-title"><a href="tricategorie.php">Trie par nom</a></strong><br>
...
?>
                                            ...
                                            <td> <?php echo $pro['id_categ'] ?> </td>
                                            <td><?php echo $pro['nom_cat'] ?></td>
                                   ...
                                   <td>     <form method="post" action="supprumercateg.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_categ'] ?>" name="id_categ">
</form></td>
<td> 
<form method="GET" action="modifiercateg.php" >
   ...
   function print(pdf)
       ...
       <div>
            <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="Ajoutercategorie.php">Ajouter Categorie</a>
